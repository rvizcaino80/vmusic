  ...
  <div class="flex flex-col justify-center min-h-0 flex-1">
    ...
    <div class="flex items-center space-x-3 justify-center">
      <button
        ...
        @click="pause()"
      >
        <Icon class="w-5 h-5 text-white" icon="material-symbols:pause" />
      </button>
      ...
      <button
        ...
        @click="play()"
      >
        <Icon class="w-5 h-5 text-white" icon="mdi:play" />
      </button>

      <button class="flex items-center space-x-2 bg-gray-800 text-white py-2 px-3" @click="save">
        <Icon class="w-5 h-5" icon="tdesign:save" />
        <span>Guardar</span>
      </button>
    </div>
  </div>
